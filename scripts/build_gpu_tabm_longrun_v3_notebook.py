...
NOTEBOOK_PATH = ROOT / "output/jupyter-notebook/data-fusion-2026-gpu-tabm-longrun-v3.ipynb"
...
def main() -> None:
    ...
    cells = [
        md_cell(
            dedent(
                """
                # Experiment: Data Fusion 2026 GPU TabM LongRun V3

                Objective:
                - Push the confirmed `TabM` backbone with the strongest next-step recipe.
        ...
        code_cell(
            (
                ...
                + dedent(
                    ...
                    ARTIFACT_DIR = Path("artifacts") / f"gpu_tabm_longrun_v3_{RESOLVED_MODE}"
